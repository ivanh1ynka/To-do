...
var arrLang = {
  en: {
    ...
    welcome: "welcome",
    heroBtn: "go next",
    service__title: "Efficient fulfillment of your orders.",
    service__text: "Contact us by filling out the data form.",
    service__btn: "form",
    contact__title: "Contact with me:",
    name: "Name:",
    email: "Email:",
    message: "Message:",

    placeholderName: "You'r name",
    placeholderEmail: "You'r email",
  ...
  ua: {
    ...
    heroBtn: "далі",
    service__title: "Оперативне виконання ваших замовлень.",
    service__text: "Зв'яжіться з нами, заповнивши форму даних.",
    service__btn: "форма",
    contact__title: "Зв'язатися зі мною:",
    name: "Ім'я:",
    email: "Пошта:",
    ...
    placeholderMesage: "Ваше повідомлення",
    placeholderBtn: "Надіслати",

    footer__text: "Ви також можете зв'язатися зі мною в соціальних мережах.",
    footer__date: "Створено в 2023році.",
    footer__name: "Іван Глинка",
  },
};
